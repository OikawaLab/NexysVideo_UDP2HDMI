...
proc update_PARAM_VALUE.FILTER_MODE_SEL { PARAM_VALUE.FILTER_MODE_SEL } {
	# Procedure called to update FILTER_MODE_SEL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FILTER_MODE_SEL { PARAM_VALUE.FILTER_MODE_SEL } {
	# Procedure called to validate FILTER_MODE_SEL
	return true
}
...
proc update_MODELPARAM_VALUE.FILTER_MODE_SEL { MODELPARAM_VALUE.FILTER_MODE_SEL PARAM_VALUE.FILTER_MODE_SEL } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FILTER_MODE_SEL}] ${MODELPARAM_VALUE.FILTER_MODE_SEL}
}
